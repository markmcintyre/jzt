...
jzt.FileManagement.SAVE_INDEX = 'saveIndex';
...
jzt.FileManagement.prototype.pruneIndex = function() {
    ...
    saveIndex = localStorage[jzt.FileManagement.SAVE_INDEX];
    ...
    if(changed) {
        localStorage[jzt.FileMangement.SAVE_INDEX] = JSON.stringify(saveIndex);
    }
...
jzt.FileManagement.prototype.saveFile = function(saveId, game) {
    ...
    localStorage[jzt.FileManagement.SAVE_INDEX] = JSON.stringify(saveIndex);
