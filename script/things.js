...
jzt.things = (function (my) {
    ...
    ActiveBomb.prototype.doTick = function () {
        ...
        if (this.timeToLive < 0) {
            explosion = new my.Explosion(this.board);
    ...
    Bear.prototype.doTick = function () {
        ...
        var BreakableWall = my.BreakableWall;
        var Player = my.Player;
        var River = my.River;
        ...
        if (this.isPlayerAligned(10 - this.sensitivity)) {
            ...
            if (thing && thing instanceof River && thing.direction === jzt.Direction.opposite(direction)) {
                return;
            }
    ...
    Bullet.prototype.react = function () {
        ...
        if (thing && !(thing instanceof Player)) {
            ...
            if (this.getAdjacentThing(jzt.Direction.clockwise(this.direction)) instanceof Ricochet) {
            ...
            if (this.getAdjacentThing(jzt.Direction.counterClockwise(this.direction)) instanceof Ricochet) {
    ...
    Ruffian.prototype.doTick = function () {
        ...
        if (this.moving) {
            ...
            // Don't move in the direction of a River
            if (thing && thing instanceof River && thing.direction === jzt.Direction.opposite(this.orientation)) {
                return;
            }
